/************************************************************************
*                                                                       *
* xfsmpi.h      XFS - MIB functions, types, and definitions             *
*                                                                       *
...
typedef struct _wfs_mib_reset_response_counts_reset
{
    SYSTEMTIME    tsTimestamp;
} WFSMIBRESETRESPONSECOUNTSRESET, * LPWFSMIBRESETRESPONSECOUNTS;
